...
contract JDCC is Context, IERC20, IERC20Errors, Ownable {
    ...
    // BSC PancakeSwap
    address public constant swapRouterAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; 
    //0x10ED43C718714eb63d5aA57B78B54704E256024E;
    // BSC WBNB
    address public wbnbAddress;// = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    // 运营地址
    address public immutable fundAddress = 0xc7977fa83BdD087C57eF5B20Aa9CBc6eD7A88dEb; // 营销钱包地址
...
event TxEvent(address);
event RunAddLP(bool);
event AddLPIn(uint256, uint256);
