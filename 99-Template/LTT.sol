/**
 *https://www.bscscan.com/token/0xce6d6bf9b761087a5483955d575466f129c277a8
*/
...
contract LTT is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        airDropAddress = 0x7F981675A082C6849514b5CE5c6484fEaaA68D75;
        _owner = 0x26040cB12aEa18807aF963F48C42CF5dfF1277D6;
        receiveAddress = _owner;

        _totalSupply = 430000  * 10 ** _decimals;
        _maxTxAmount = 0;
        ...
        IAirdrop(airDropAddress).init(address(this));
        _balances[_owner] = 60000 * 10 ** _decimals;
        emit Transfer(address(0), _owner, 60000 * 10 ** _decimals);
        _balances[airDropAddress] = 370000 * 10 ** _decimals;
        emit Transfer(address(0), airDropAddress, 370000 * 10 ** _decimals);
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount,bool takeFe,bool isRemoveLP) internal {
        ...
        if (takeFe) {
            if (isRemoveLP) {
                ...
                if(block.timestamp < _startTradeTime+3600){
